...
class Weibo(object):
    cookie = {'Cookie': '_T_WM=96956466209; SUB=_2A25PZunaDeRhGeNH4lYU8SrPyT2IHXVsqPeSrDV6PUNbktCOLUWmkW1NSktJNj3Fi1OaJptUm4-CO-tVhmvBLTBd; SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9W516SozIC_g5zvih8IGZv1B5JpX5KzhUgL.Fo-41KBfeKB0eo22dJLoIEXLxKML1hBLBoqLxKML1hBLBoqLxK-LBKBL12BLxKML1hBLBoqLxKML1hBLBoqt; SSOLoginState=1650629002; ALF=1653221002; XSRF-TOKEN=ff19d4; WEIBOCN_FROM=1110006030; MLOGIN=1; mweibo_short_token=f57c68f383; M_WEIBOCN_PARAMS=luicode%3D20000174%26uicode%3D20000174'}  # 将your cookie替换成自己的cookie
...
def main():
    try:
        ...
        user_id = 1662011110  # 可以改成任意合法的用户id（爬虫的微博id除外）
